...
if __name__ == "__main__":
    ...
    close_path = os.path.join(os.getcwd(),'tmp', "close.parquet")
    volume_path = os.path.join(os.getcwd(),'tmp', "volume.parquet")
    final_path = os.path.join(os.getcwd(),'tmp', "factors.parquet")
